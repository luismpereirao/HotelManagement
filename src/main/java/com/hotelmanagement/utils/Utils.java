...
public class Utils {
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user) {
        ...
        if (!user.getBookings().isEmpty()) {
            userDTO.setBookings(user.getBookings().stream().map(booking -> mapBookingEntityToBookingDTOPlusBookedRoom(booking, false).Collectors.toList()));
        }

        return userDTO;
    }

    private static BookingDTO mapBookingEntityToBookingDTOPlusBookedRoom(Booking booking, boolean mapUser) {
        BookingDTO bookingDTO = new BookingDTO();
