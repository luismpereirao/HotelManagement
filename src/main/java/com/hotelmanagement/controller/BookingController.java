...
import com.hotelmanagement.services.impl.BookingService;
...
public class BookingController {
    ...
    public ResponseEntity<Response> getBookingByConfirmationCode(@RequestParam String confirmationCode) {
